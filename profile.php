...
<?php
    ...
    $sql = "SELECT DISTINCT vId, comment FROM video WHERE usersId = '$userid'";
                            ...
                            <div class="rela-block container">
                                ...
                                .background-img {
                                    ...
                                    <?php 
                                        ...
                                        <a href="all_followers.php" class="floated profile-stat followers h" id="num_followers"><?php echo $followers?><br></a>
                                        <a href="all_following.php" class="floated profile-stat following h" id="num_following"><?php echo $followings?><br></a>
                                ...
                                <div class="rela-block content"style="display: flex;">
                                    ...
                                    <div class="videoBlock" style="display:none;">
                                        ...
                                        // 建立 SQL 查詢字串，查詢使用者名稱
                                        $sql = "SELECT DISTINCT vId, vType FROM video WHERE usersId = '$userid'";

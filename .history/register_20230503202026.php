                            ...
                            <form action="includes/signup.inc.php" method="post" class="user">
                                ...
                                <div class="form-group row">
                                    <div class="mb-3 mb-sm-0" style="display:flex; padding:0 10px;">
                                        <!-- Username -->
                                        <i class="fa fa-user fa-lg" style="padding:12px;"></i>
                                ...
                                <div class="form-group" style="display:flex;">
                                    <i class="fa fa-envelope fa-lg" style="padding:12px; width: 400px;"></i>
                                ...
                                <div class="form-group row">
                                    <div class="mb-3 mb-sm-0" style="display:flex; padding:0 10px;">
                                        <i class="fa fa-lock fa-lg" style="padding:12px;"></i>

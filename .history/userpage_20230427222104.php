                ...
                <div class="container-fluid">
                        ...
                        <!-- PAGE STUFF -->
                            ...
                            <div class="rela-block container">
                                <div class="rela-block profile-card" style="flex-wrap:wrap;">
                                <?php    
                                        // 將二進制數據轉換為 base64 字串
                                ...
                                .background-img {
                                    ...
                                    <?php
                                        ...
                                        if ($is_following) {
                                            ?><button class="btn btn-primary btn-primary">Unfollow</button> <?php
                                        } else {
                                            ?><button class="btn btn-primary btn-info">Follow</button> <?php
                                        }
                                    ?>    
                                    </div>
                                </div>

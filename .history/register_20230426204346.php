...
// 設定 SQL 查詢字串
$sql_read = "SELECT usersId FROM users WHERE usersUId = '$userid'";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        // 設定 URL
        $url = "edit.php?id=" . $row['usersId'];
        
        // 更新資料庫
        $update_sql = "UPDATE users SET usersUrl = '$url' WHERE usersId = " . $row['usersUiId'];

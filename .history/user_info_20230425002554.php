...
if (isset($_POST["submit"])) {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['size'] > 0) {
        ...
        // 建立 SQL 指令
        $sql = "UPDATE `users` SET `usersName`='$uname', `usersDesc`='$udesc', `usersIMG`='$img' WHERE `usersId`='$userid'";  
    }else{
        $sql = "UPDATE `users` SET `usersName`='$uname', `usersDesc`='$udesc' WHERE `usersId`='$userid'";  
    }

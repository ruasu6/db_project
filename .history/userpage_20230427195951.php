<?php
    ...
    function check_if_user_is_following($current_user_id, $user_id_to_follow) {$sql_f = "SELECT * FROM `follows` WHERE `currentUserId` = '$current_user_id' AND `followedUserId` = '$user_id_to_follow'";

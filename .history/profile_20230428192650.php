<?php
    ...
    if ($result->num_rows > 0) {
        ...
        $img = $row["usersIMG"];
        $posts = $row["po"]
        $followers = $row["usersIMG"]
        $followings = $row["usersIMG"]
    } else {
        echo "查無此使用者";
    }
                            ...
                            <div class="rela-block container">
                                ...
                                .background-img {
                                    ...
                                    <div class="rela-block profile-card-stats">
                                        <div class="floated profile-stat works" id="num_works"><?php $posts?><br></div>
                                        
                                        <div class="floated profile-stat followers" id="num_followers"><?php $followers?><br></div>
                                        
                                        <div class="floated profile-stat following" id="num_following"><?php $followings?><br></div>

...
if (isset($_POST["follow"])) {
    ...
    // header("Location:http://localhost/startbootstrap-sb-admin-2-gh-pages/userpage.php?varname=$userid#");
...
if (isset($_POST["unfollow"])) {
    ...
    echo "<script>alert('unfollowed');</script>";
                            ...
                            <div class="rela-block container">
                                ...
                                .background-img {
                                    ...
                                    <div class="rela-block profile-card-stats">
                                        ...
                                        <div class="floated profile-stat followers" id="num_followers"><?php echo $posts?><br></div>
                                        
                                        <div class="floated profile-stat following" id="num_following"><?php echo $posts?><br></div>

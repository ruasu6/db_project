                            ...
                            <div class="rela-block container">
                                ...
                                .background-img {
                                    ...
                                    <?php
                                        ...
                                        if ($is_following) {
                                            ?><button id style="margin: 0 10px;" class="btn btn-primary btn-primary">Unfollow</button> <?php
                                        } else {
                                            ?><button style="margin: 0 10px;" class="btn btn-primary btn-info">Follow</button> <?php
                                        }
                                    ?>
                                    <script>
                                        // 取得按鈕元素

...
if (isset($_POST["follow"])) {
    $sql_s = "INSERT INTO follows (currentUserId, followedUserId) VALUES ($current_user_id, $var)";
...
if (isset($_POST["unfollow"])) {
    $sql_u = "DELETE follows (currentUserId, followedUserId) VALUES ($current_user_id, $user_id_to_follow)";

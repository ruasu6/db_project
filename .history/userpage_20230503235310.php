...
<?php
    ...
    $sql = "SELECT comment FROM video WHERE usersId = '$var'";
                            ...
                            <div class="rela-block container">
                                            ...
                                            <?php
                                                ...
                                                if($current_user_id != $user_id_to_follow){
                                                    if (check_if_user_is_following($current_user_id, $user_id_to_follow, $conn_new) == true) {
                                                        echo '<button name="unfollow" id="submit-btn" style="margin: 0 10px;display: flex;justify-content: center;" class="btn btn-primary btn-primary">Unfollow</button>';
                                                    } else {
                                                        echo '<button name="follow" id="submit-btn" style="margin: 0 10px;display: flex;justify-content: center;" class="btn btn-primary btn-info">Follow</button>';
                                                    }
                                                }
                                            ?>
                                        </form>
                                ...
                                <div class="rela-block content"style = "display:flex">
                                    ...
                                    <div class="videoBlock" style="display:none;">
                                        ...
                                        // 建立 SQL 查詢字串，查詢使用者名稱
                                        $sql_video = "SELECT vId, vType FROM video WHERE usersId = '$var'";

                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5" style="padding-left:20px;">
                            ...
                            <form action="includes/signup.inc.php" method="post" class="user" style="padding-left:25px;">
                                ...
                                <br>
                                <!-- Submit -->
                                <button type="submit" name="submit" class="btn btn-primary btn-user btn-block" style="width : 400px; padding-left:100px;">Register Account</button>

...
if (isset($_POST["unfollow"])) {
    ...
    header("Location:http://localhost/startbootstrap-sb-admin-2-gh-pages/userpage.php?varname=$userid#");check_if_user_is_following($current_user_id, $user_id_to_follow, $conn_new) == false;
}

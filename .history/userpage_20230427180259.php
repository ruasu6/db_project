<?php
    ...
    function check_if_user_is_following($current_user_id, $user_id_to_follow, $row_f, $var) {
         // 在此處檢查是否已經追蹤該用戶，例如：
                                ...
                                .background-img {
                                    ...
                                    <?php
                                        ...
                                        if($current_user_id != $user_id_to_follow){
                                            $is_following = check_if_user_is_following($current_user_id, $user_id_to_follow, $row_f, $var);

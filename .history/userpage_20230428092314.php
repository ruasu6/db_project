...
if (isset($_POST["follow"])) {
    echo "<script>prompt('要顯示的文字');</script>";
                            ...
                            <div class="rela-block container">
                                ...
                                .background-img {
                                    ...
                                    <?php
                                        ...
                                        // 在此處檢查當前用戶是否已經追蹤了該用戶
                                        ?>
                                        <button name="follow" id="submit-btn" style="margin: 0 10px;" class="btn btn-primary btn-info">Follow</button>
                                        <?php
                                        // if (check_if_user_is_following($current_user_id, $user_id_to_follow, $conn)) {

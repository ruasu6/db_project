...
$.getJSON(self.options.dataUrl,
    ...
    if (dataArr.length > 0) {
        ...
        $.each(dataArr, function (key, val) {
            if (val.similarity>=0.5) {
            items.push("<div class=\"media text-muted border-bottom border-gray\" style=\"width: 400px; height: 120px; margin: 15px 15px 15px 30px;\">" + 
                            "<img data-src=\"holder.js/32x32?theme=thumb&amp;bg=007bff&amp;fg=007bff&amp;size=1\" alt=\"32x32\" class\"mr-2 rounded\" src=\"data:image;base64," + val.img + "\" data-holder-rendered=\"true\" style=\"width: 100px; height: 100px; object-fit: cover;\"/>" +
                            "<div class=\"media-body pb-3 mb-0 small lh-125 \" style=\"height: 100px;\">"+
                                ...
                                "<a>"+"此用戶和你的片單相似度為"+Math.round(val.similarity * 100)+ "%"+"</a>"+
                            "</div>"+
